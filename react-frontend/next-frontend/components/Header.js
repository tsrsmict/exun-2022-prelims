...
function Header() {
  return (
    <nav className="backdrop-blur-xl bg-black opacity-60 border-gray-200 px-2 sm:px-4 py-2.5 rounded">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <a href="https://flowbite.com/" className="flex items-center">
            <Image src="/public/logo.svg" className="mr-3 h-6 sm:h-9" width={56} height={56} alt="Flowbite Logo"></Image>
