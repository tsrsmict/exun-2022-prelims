...
function Header() {
  return (
    <nav className="backdrop-blur-3xl w-screen bg-black bg-opacity-30 shadow-sm sticky shadow-zinc-800 z-50 border-gray-200 px-2 sm:px-4 py-2.5 rounded">
      <div className="container flex flex-wrap mx-auto justify-between items-center w-screen">
        <a href="https://flowbite.com/" className="flex left-0">
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Retro</span>
        </a>
        ...
        <div className="hidden w-full md:block md:w-auto right-0" id="navbar-default">
